...
DROP SCHEMA `Little_Lemon`;

CREATE SCHEMA `Little_Lemon` DEFAULT CHARACTER SET utf8;
USE `LL_Database` ;

CREATE TABLE `Little_Lemon`.`Booking` (
...
CREATE TABLE `Little_Lemon`.`Customer` (
...
CREATE TABLE `Little_Lemon`.`Menu` (
  `MenuID` INT NOT NULL,
...
CREATE TABLE `Little_Lemon`.`DeliveryStatus` (
  `DeliveryID` INT NOT NULL,
  `DeliveryDate` DATETIME NOT NULL,
  PRIMARY KEY (`DeliveryID`))
ENGINE = InnoDB;

CREATE TABLE `Little_Lemon`.`Orders` (
...
CREATE TABLE `Little_Lemon`.`Staff` (
